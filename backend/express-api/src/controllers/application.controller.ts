...
export class ApplicationController {
  async submitApplication(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return sendSuccess(res, mapApplication(application), 'Application submitted successfully', 201)
    } catch (error) {
      next(error)
    }
  }
  ...
  async getApplication(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return sendSuccess(res, mapApplication(application), 'Application retrieved')
    } catch (error) {
      next(error)
    }
  }
  ...
  async updateStatus(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return sendSuccess(res, mapApplication(updatedApplication), 'Application status updated successfully')
    } catch (error) {
      next(error)
    }
  }
  ...
  async listJobApplications(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return sendSuccess(res, applications.map(mapApplication), 'Job applications retrieved')
    } catch (error) {
      next(error)
    }
  }
  ...
  async listCandidateApplications(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return sendSuccess(res, applications.map(mapApplication), 'Candidate applications retrieved')
    } catch (error) {
      next(error)
    }
  }
